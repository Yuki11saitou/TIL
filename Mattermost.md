...
- Rails応用8 → あろうことかまた復習で終わりましたが、明日からは9に進めます。
  - この課題で理解に苦慮したのが```app/decorators/article_block_decorator.rb```の記述ですが、複雑になっている要因に、下記4点があるかなと感じてます。
    - 登場するテーブルが６種類あること
    - sourceオプションだけでなく、source_typeオプションが使われていること(Rails基礎との違い)
    - ポリモーフィック関連が使用されていること(上の項目と被るが)
    - enumが使用されていること
  
  - しかも4点が互いに関係しあっているから複雑に...
  - 見た目こそシンプルなメソッドに見えるが、「なぜそれで情報が取得できるのか」訳わからなくなる。
  - iPadにテーブルの関係性を書き出して、Railsガイド読んでからやっと納得感が得られました💦
...
# あとにとっとく
[余談]  
4月から始まったアニメで継続して見ている作品が2つあります。
- 怪獣8号
- 夜のクラゲは泳げない

「何でこの２作品が残ったんだろう」と思ったのですが、共通点がありました。

- 主人公が、今までの経験から自らを凡人だと認識しており、夢を諦めていた。
- あるきっかけ・才能豊かな人と関わることで、再度夢に挑戦し始めた。  
  
ここが、何となく共通して自分に刺さったのかな〜と思います。  
そしてもう少ししたらアニメ「鬼滅の刃」が再スタートするのでそちらも楽しみにしたいと思います。