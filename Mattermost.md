...
[コメント] スタンプえぐすぎぃ！いちご100個も食えませんw
- paiza
- インフラ入門1~5
  - AWSアカウントは過去に登録してたが、登録した後も結構工程があるんですね〜。
  - 12ヶ月の無料枠が切れているので、公式サイトで調べたけど、EC2インスタンスの起動で課金されそう。
  - 一応質問してみたけど、水曜は質問回答お休み。よって既存アカウントのまま突っ走る(別アカウント作るのが面倒)！課金されたら泣けばいい。
-  5ヶ月目振り返りnote途中
...
- YouTubeライブ視聴→[プログラミング学習は会社を辞めて取り組むべき？仕事は辞めないほうがいい？](https://www.youtube.com/live/0Y1ohm64uP8?si=dtIm7IupimIWEPDA)
  - 私としては、残業時間的に絶対に仕事を辞める他なかったので選択肢は一択だった。
  - だけど、職歴に穴は空くし、「合わなかった」となった時の取り返しがつかない。一長一短ですよね。


[記録] 6/5(水)_Day149_hm(/1000)  
[学習内容] インフラ入門5, / TECH CHAT ROOM / その他  
[コメント] 
- paiza
- インフラ入門5
-  5ヶ月目振り返りnote途中
