...
- 「53期：スケジュール相談面談」に申し込みをしました。
  - 相談というか、もう自分の中で答えはほぼ出ているのですが、、、
    - 学習ペースに見合わずtimes、X、noteの更新、更にはイベント、Udemy、paizaなどに時間を使ってしまうのは猛省。
    - もちろん両立できてる人なら良いんだけど、自分はそんな能力も器用さもない。
    - 頭では理解してるけど、卒業が第一優先だから、暫くこちらに力をかけたいと思います。
